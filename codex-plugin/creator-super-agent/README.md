...
Image generation is cloud-multimodal-first: ChatGPT/OpenAI `gpt-image-2` or a configured compatible image model. Paid calls and visual approval remain gated.
