...
Inside Codex, the default image route is built-in `image_gen` / `gpt-image-2`, followed by versioned project import and visual QA V2. Direct API image calls and final visual approval remain gated.
